...
// see the process-workflows cron job in 20260822000000_workflows.sql). Not a
// simulation: task creation, tag/status changes, wait timing, and (once
// SLACK_BOT_TOKEN is set) Slack alerts are all real. Instantly nurture
// sends are still stubbed (logged to workflow_alert_log) pending a real
