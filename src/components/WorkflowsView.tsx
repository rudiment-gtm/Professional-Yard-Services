...
const STARTERS: Starter[] = [
  {
    key: 'win-back',
    title: 'Win back a canceled account',
    description: 'Account status changes to Canceled',
    draft: {
      name: 'Win back a canceled account',
    ...
    return (
      <div className="rounded-lg border p-3 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Not connected yet — an admin needs to add the Slack app.</p>
        </div>
...
function StepCard({
  ...
  return (
    <div className="glass-card p-3 space-y-2">
      ...
      {step.type === 'nurture' && (
        <div className="rounded-lg border border-primary bg-primary/10 p-2 text-left text-xs">
