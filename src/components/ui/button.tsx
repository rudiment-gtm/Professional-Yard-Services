...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // Primary actions get a pill + glow treatment, distinct from the
        // flat rounded-md rectangles used everywhere else.
        default:
          "rounded-full font-semibold bg-primary text-primary-foreground shadow-[0_4px_20px_-2px_hsl(var(--primary)/0.45),0_0_0_1px_hsl(var(--primary)/0.3)] hover:bg-primary/90 hover:shadow-[0_4px_24px_-2px_hsl(var(--primary)/0.55),0_0_0_1px_hsl(var(--primary)/0.4)]",
