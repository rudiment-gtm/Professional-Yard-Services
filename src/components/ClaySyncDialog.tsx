...
import { CloudDownload, Copy, Check, ExternalLink } from 'lucide-react';
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" size="sm" className="gap-2">
          ...
          <span className="hidden sm:inline">Sync from Clay</span>
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[500px] max-h-[85vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle>Connect Clay.com via Webhook</DialogTitle>
          <DialogDescription>
            Configure Clay to push data to your app automatically when rows are added or updated.
          </DialogDescription>
        </DialogHeader>
