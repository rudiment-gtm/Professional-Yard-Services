...
const prospectCategoryMap: Record<ProspectCategory, string[]> = {
  ...
  retail: ['shopping', 'convenience_store', 'department_store'],
  restaurant: ['restaurant', 'cafe', 'fast_food'],
  office: ['office', 'professional_services'],
  newConstruction: [],
  other: ['business'],
};
...
// Mapbox categories (HOAs, new-construction subdivisions rarely show up as POIs).
const prospectQueryMap: Partial<Record<ProspectCategory, string[]>> = {
  ...
  commercial: ['commercial property management', 'business park'],
  newConstruction: ['new home community', 'new construction homes', 'model home'],
};
